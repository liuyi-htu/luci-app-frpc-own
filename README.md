...
<img width="2554" height="1250" alt="image" src="https://github.com/user-attachments/assets/8b0b9b8c-662b-47a3-b28f-9139a5e6e882" />
...
## SDK 构建
由于确实二进制文件，直接编译到固件后大概率不能正常使用，推荐单独编译安装包
